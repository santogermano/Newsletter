...
- **Single-file SPA**: The entire application lives in `Newsletter Generator.html` (~4,700 lines of embedded HTML, CSS, and vanilla JavaScript)
...
2. **HELPERS** — Utility functions (`slugify`, `cleanText`, `truncateWords`, `debounce`)
...
- **CSS custom properties**: theming via `--ink`, `--accent`, `--card`, etc.
